...
echo "Installing Pragma in /usr/lib/$PRAGMA_DIR_NAME..."
sudo chmod +x /tmp/pragma/$PRAGMA_DIR_NAME/bin/pragma
sudo mv /tmp/pragma/$PRAGMA_DIR_NAME/ /usr/lib/

echo "Creating symbolic link /usr/lib/$PRAGMA_DIR_NAME/bin/pragma -> /usr/bin/pragma"
sudo ln -s /usr/lib/$PRAGMA_DIR_NAME/bin/pragma /usr/bin/pragma
